...
if args.load:
    model.load_state_dict(torch.load(f'models/fmnist/model_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.bin'))
else:
...
# Save model
if not args.load:
    torch.save(model.state_dict(), f'models/fmnist/model_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.bin')
...
np.save(f'results/fmnist/y_test_fmnist_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.npy', y_FMNIST)
np.save(f'results/fmnist/y_test_fmnist_ud_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.npy', y_FMNIST_ud)
np.save(f'results/fmnist/y_test_fmnist_lr_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.npy', y_FMNIST_lr)
np.save(f'results/fmnist/y_test_mnist_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.npy', y_MNIST)
np.save(f'results/fmnist/y_test_notmnist_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}.npy', y_notMNIST)
...
# Save data
np.save(f'results/fmnist/accs_adv_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}_{args.adv_samples}.npy', adv_accs)
np.save(f'results/fmnist/ents_adv_{name}_{h_dim}_{h_dim_hypernet}_{m}_{lr}_{S}_{args.adv_samples}.npy', adv_ents)
